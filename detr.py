...
class Detection_Transformers(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/content/detr-pytorch/model_data/detr_resnet50_weights_coco.pth',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='/content/detr-pytorch/model_data/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
